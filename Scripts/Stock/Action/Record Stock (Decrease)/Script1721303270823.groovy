...
'Tap on record Stock'
Mobile.tap(findTestObject('Stock/StockPageOBJ/android.view.View(RecordStock)'), 0)
...
'Scroll to product name Headlamp'
Mobile.scrollToText('Headlamp', FailureHandling.CONTINUE_ON_FAILURE)
...
'Tap on plus BTN to decrease stock'
Mobile.tap(findTestObject('Stock/StockPageOBJ/android.widget.Button(ProductMinusBTN)'), 0)
...
'Select a reason'
Mobile.tap(findTestObject('Stock/StockPageOBJ/android.view.View(ReturnedStock)'), 0)
