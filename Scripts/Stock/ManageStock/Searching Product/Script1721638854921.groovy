...
'Tap on Search box'
Mobile.tap(findTestObject('Stock/StockPageOBJ/Manage/android.widget.EditText(StockSearchField)'), 0)

Mobile.delay(2)

'Supplier Description'
Mobile.setText(findTestObject('Stock/StockPageOBJ/Manage/android.widget.EditText(StockSearchField)'), 'ca', 0)
