...
//'tap on profile but scan open'
//Mobile.tap(findTestObject('Stock/android.widget.ImageView(scan)'), 0)
...
//'Radio button of Management Workspace'
//Mobile.tap(findTestObject('Stock/android.widget.RadioButton(MW_RadioBTN)'), 0)
