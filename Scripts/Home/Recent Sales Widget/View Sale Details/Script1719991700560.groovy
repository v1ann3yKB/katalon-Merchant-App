...
'Tap on First Recent Sales'
Mobile.tap(findTestObject('Home Actions and tab/HomeOBJ/android.view.View(FirstRSales)'), 0)

'3s delay'
Mobile.delay(3)

'Tap on View Receipt'
Mobile.tap(findTestObject('Home Actions and tab/HomeOBJ/android.widget.Button(ViewReceipt)'), 0)
