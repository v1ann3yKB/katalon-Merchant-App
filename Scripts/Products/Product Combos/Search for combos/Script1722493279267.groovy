...
'Tap on Product Combos'
Mobile.tap(findTestObject('Products/Products Main Page/android.view.View(ManageCombosSection)'), 0)

Mobile.delay(3)

'Tap on Search box in Combo'
Mobile.tap(findTestObject('Products/Combos/android.widget.EditText(CombosSearchBox)'), 0)

Mobile.delay(3)

Mobile.setText(findTestObject('Products/Combos/android.widget.EditText(CombosSearchBox)'), 'carp', 0)
