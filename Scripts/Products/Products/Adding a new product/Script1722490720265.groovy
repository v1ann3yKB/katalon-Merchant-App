...
//
//'Tap on Add Products'
//Mobile.tap(findTestObject('Products/Products Main Page/Products/android.widget.Button(AddProductBTN)'), 0)
...
Mobile.setText(findTestObject('Products/Products Main Page/Products/android.widget.EditText(ProductNameField)'), 'New Products', 
    0)

Mobile.delay(5)

'Tap on Product Category'
Mobile.tap(findTestObject('Products/Products Main Page/Products/android.widget.Button(ProductCategorySelectField)'), 0)

Mobile.delay(5)

'Tap on Category'
Mobile.tap(findTestObject('Products/Products Main Page/Products/android.view.View(ProductCategoryBottles)'), 0)

Mobile.delay(5)

Mobile.hideKeyboard()

'Tap on Create Product'
