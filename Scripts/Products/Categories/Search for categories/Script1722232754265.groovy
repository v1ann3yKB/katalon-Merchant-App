...
'Tap on Search box'
Mobile.tap(findTestObject('Products/Category/android.widget.EditText(CategorySearchBox)'), 0)

Mobile.delay(3)

'search for Electronics'
Mobile.setText(findTestObject('Products/Category/android.widget.EditText(CategorySearchBox)'), 'Electronics', 0)
