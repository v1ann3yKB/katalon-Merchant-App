...
'Tap on Add Products BTN'
Mobile.tap(findTestObject('Products/Category/android.widget.Button(AddProductInProductBTN)'), 0)

Mobile.delay(3)

'Tap on Goldfish Product'
Mobile.tap(findTestObject('Products/Category/android.view.View(Goldfish Product)'), 0)

Mobile.delay(3)

'Tap on Save Added Products BTN'
Mobile.tap(findTestObject('Products/Category/android.widget.Button(SaveAddedProducts)'), 0)
