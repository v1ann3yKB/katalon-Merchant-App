...
Mobile.tap(findTestObject('Products/Products Main Page/android.view.View(ManageCategoriesSection)'), 0)

Mobile.delay(2)

'Tap on Filter'
Mobile.tap(findTestObject('Products/Category/android.widget.Button(CategoryFilterBTN)'), 0)

Mobile.delay(3)

'Select filter by name'
Mobile.tap(findTestObject('Products/Category/android.view.View(CategoryNameFilter)'), 0)
...
Mobile.tap(findTestObject('Products/Category/android.view.View(CreatedDateFilter)'), 0)
