...
'set name'
Mobile.setText(findTestObject('Products/Products Main Page/Discounts/android.widget.EditText(Namefield)'), 'Amount based', 
    0)

Mobile.delay(3)

'set description'
Mobile.setText(findTestObject('Products/Products Main Page/Discounts/android.widget.EditText(DescriptionField)'), 'This is an Amount based discount', 
    0)

Mobile.delay(3)

'Tap on discount amount field'
Mobile.tap(findTestObject('Products/Products Main Page/Discounts/android.view.View(DiscountAmountField)'), 0)
