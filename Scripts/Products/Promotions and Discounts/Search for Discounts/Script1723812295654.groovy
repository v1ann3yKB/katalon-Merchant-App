...
//Mobile.tap(findTestObject('Products/Products Main Page/android.view.View(ManagePromoDiscountSection)'), 0)
//
//Mobile.delay(5)
...
//'Tap on search Box'
//Mobile.tap(findTestObject('Products/Products Main Page/Discounts/android.widget.EditText(Search)'), 0)
//
//Mobile.delay(3)
//
//Mobile.setText(findTestObject('Products/Products Main Page/Discounts/android.widget.EditText(Search)'), 'gu', 0)
//
//Mobile.delay(10)
//
