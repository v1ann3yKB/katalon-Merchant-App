...
'Tap on voids tab'
Mobile.tap(findTestObject('Transactions/Voids and Withdrawal/android.view.View(voidsTAB)'), 0)

Mobile.delay(5, FailureHandling.CONTINUE_ON_FAILURE)

'Open item in void list item'
Mobile.tap(findTestObject('Transactions/Voids and Withdrawal/android.view.View(voidItem1)'), 0)
