...
'Store WorkSpace'
Mobile.tap(findTestObject('User Profile Switching/Workspace/Profile Switching/android.view.View (1)'), 
    0)
...
'LogOut'
Mobile.tap(findTestObject('User Profile Switching/Workspace/Profile Switching/android.view.View (2)'), 
    0)
