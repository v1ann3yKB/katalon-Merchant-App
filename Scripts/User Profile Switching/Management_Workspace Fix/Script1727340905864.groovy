...
//    true)
//
//Mobile.tap(findTestObject('User Profile Switching/Fixes/android.widget.Button'), 0)
//
//Mobile.tap(findTestObject('User Profile Switching/Fixes/android.widget.EditText'), 0)
//
//Mobile.setText(findTestObject('User Profile Switching/Fixes/android.widget.EditText (1)'), 'sealegeneral@gmail.com', 
//    0)
//
//Mobile.setText(findTestObject('User Profile Switching/Fixes/android.widget.EditText (2)'), 'Password123!', 
//    0)
//
//Mobile.tap(findTestObject('User Profile Switching/Fixes/android.widget.Button (1)'), 0)
//
