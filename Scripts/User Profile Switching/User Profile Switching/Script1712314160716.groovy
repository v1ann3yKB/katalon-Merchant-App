...
//    true)
//
//Mobile.tap(findTestObject('User Profile Switching/android.widget.Button'), 0)
//
//Mobile.setText(findTestObject('User Profile Switching/android.widget.EditText - Username (Email Address)'), 
//    'demo@littlefishapp.com', 0)
//
//Mobile.setText(findTestObject('User Profile Switching/android.widget.EditText - Password'), 'Password123!', 
//    0)
//
//Mobile.tap(findTestObject('User Profile Switching/android.widget.Button (1)'), 0)
//
//Mobile.delay(5)
...
Mobile.tap(findTestObject('User Profile Switching/android.view.View'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('User Profile Switching/android.view.ViewGroup'), 0)

Mobile.delay(3)

Mobile.tap(findTestObject('User Profile Switching/android.widget.Button - Update'), 0)

Mobile.delay(3)

Mobile.tap(findTestObject('User Profile Switching/android.view.View (1)'), 0)

Mobile.delay(3)

'store management'
Mobile.tap(findTestObject('User Profile Switching/android.view.View (2)'), 0)
